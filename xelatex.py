...
texfile=open("_build/latex/FFTWLearningNotes.tex","r")
texfiletmp=open("_build/latex/FFTWLearningNotes.tex~","w")
...
os.system("mv _build/latex/FFTWLearningNotes.tex~ _build/latex/FFTWLearningNotes.tex")
